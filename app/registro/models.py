...
from esterilizaya.constantes import SEXO, ESPECIE, EDADES, RAZON_TENENCIA
...
class Registro(models.Model):
    ...
    numero_turno = models.PositiveSmallIntegerField(help_text="Número turno", validators=[MaxValueValidator(50), MinValueValidator(1)])
    # Datos generales
